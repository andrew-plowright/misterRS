MonteCarloAccuracy <- function(trainingPts, classifier, segID, reclass, iterations = 100, validPrc = 0.1, dropClasses = NULL){

  # Read training data
  alldata <- do.call(rbind, lapply(trainingPts, function(tp) read.csv(tp@datafile)))
...
TrainingDataSummary <- function(trainingPts, reclass){
