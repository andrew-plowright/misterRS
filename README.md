...
- Generating segment metrics
- Classifying segments

**Developer's note:** This library is developed mainly for my personal workflow and so its structure is still very much un flux. As such, it's unlikely to be of immediate use to anyone else at this point, but please give me a shout if you find anything of interest. -- Andrew
